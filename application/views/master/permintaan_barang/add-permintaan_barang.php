...
<form method="POST" autocomplete="off" action="<?= base_url('master/Permintaan_barang/insert_barang') ?>" id="upload-create">
  ...
  <div class="form-group">
    <label>Fungsi</label>
    <textarea class="form-control" name="fungsi[]" rows="1" id=""></textarea>
  </div>
  <div class="form-group">
    <label>Target Tanggal Datang</label>
    <input style="" type="date" class="form-control" name="target[]">
  </div>
