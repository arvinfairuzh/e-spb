        ...
        <div class="box">
          ...
          <div class="box-header">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="pull-right"> <a href="<?= base_url('master/User/create') ?>">
...
<script type="text/javascript">
  function loadtable(status) {
    var table = '<table class="table table-bordered" id="mytable">' +
      '     <thead>' +
      '     <tr class="bg-success">' +
      '       <th style="width:20px">No</th>' + '<th>Username</th>' + '<th>Name</th>' + '<th>Email</th>' + '<th>Password</th>' + '<th>Role</th>' + '<th>Desc</th>' + '       <th style="width:150px">Status</th>' +
    ...
    var t = $("#mytable").dataTable({
      ...
      serverSide: true,
      ajax: {
        "url": "<?= base_url('master/User/json?status=') ?>" + status,
        "type": "POST"
      },
      columns: [{
          "data": "id",
