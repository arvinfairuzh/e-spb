...
<form method="POST" autocomplete="off" action="<?= base_url('master/Permintaan_barang/ubah_barang/' . $permintaan_barang_sub['id']) ?>">
    ...
    <div class="form-group <?= $form_hide ?>">
        <label>Fungsi</label>
        <textarea class="form-control" name="fungsi[]" rows="1" id=""><?= $permintaan_barang_sub['fungsi'] ?></textarea>
    </div>
    <div class="form-group <?= $form_hide ?>">
        <label>Target Tanggal Datang</label>
        <input style="" type="date" class="form-control" value="<?= $permintaan_barang_sub['target'] ?>" name="target[]">
    </div>
