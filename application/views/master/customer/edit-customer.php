  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <input type="hidden" name="id" value="<?= $customer['id'] ?>">
                ...
                <div class="show_error"></div><div class="form-group">
                      ...
                      <input type="text" class="form-control" id="form-nama" placeholder="Masukan Nama" name="dt[nama]" value="<?= $customer['nama'] ?>">

                  </div><div class="form-group">

                      <label for="form-email">Email</label>

                      <input type="text" class="form-control" id="form-email" placeholder="Masukan Email" name="dt[email]" value="<?= $customer['email'] ?>">

                  </div><div class="form-group">

                      <label for="form-telp">Telp</label>

                      <input type="text" class="form-control" id="form-telp" placeholder="Masukan Telp" name="dt[telp]" value="<?= $customer['telp'] ?>">
                      ...
                      <select name="dt[alamat]" class="form-control select2">
                        ...
                        foreach ($role as $role_record) {
                          ...
                          if($role_record['id']==$customer['alamat']){
