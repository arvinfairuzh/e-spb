...
<form method="POST" autocomplete="off" action="<?= base_url('master/Permintaan_barang/ubah_alat/' . $permintaan_barang_sub['id']) ?>">
    ...
    <div class="form-group autocomplete <?= $form_hide ?> ">
        <label>Jenis Barang</label>
        <input type="text" class="form-control" id="myInput" value="<?= $permintaan_barang_sub['id_barang'] ?>" name="id_barang[]">
    </div>
    <div class="form-group <?= $form_hide ?>">
        <label>Volume</label>
        <input style="" type="number" step="0.01" max="<?= $permintaan_barang_sub['qty'] ?>" value="<?= $permintaan_barang_sub['qty'] ?>" class="form-control qty" id="qty" name="qty[]">
    </div>
    <div class="form-group <?= $form_hide ?> ">
        <label>Satuan</label>
    ...
    <div class="form-group <?= $form_hide ?> ">
        ...
        <input style="" type="text" class="form-control" value="<?= $permintaan_barang_sub['kapasitas'] ?>" name="kapasitas[]">
    </div>
    <div class="form-group <?= $form_hide ?> ">
        <label>Merk</label>
        <input style="" type="text" class="form-control" value="<?= $permintaan_barang_sub['merk'] ?>" name="merk[]">
    </div>
    <div class="form-group <?= $form_hide ?> ">
        <label>Waktu Pemakaian</label>
        <input style="" type="date" class="form-control" value="<?= $permintaan_barang_sub['waktu_pemakaian'] ?>" name="waktu_pemakaian[]">
    </div>
