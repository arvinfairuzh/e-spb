<form method="POST" autocomplete="off" action="<?= base_url('master/Permintaan_barang/tambah_file/') ?>" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <hr>
        <button type="submit" class="btn btn-primary btn-send">Tambah</button>
