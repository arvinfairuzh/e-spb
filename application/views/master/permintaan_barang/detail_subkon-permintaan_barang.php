                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <p>
                                                                                        <?php
                                                                                                        $master_persyaratan_notifikasi = $this->mymodel->selectWhere('master_persyaratan', null);
                                                                                                        $persyaratan_notifikasi = json_decode($pbs->persyaratan);
                                                                                                        foreach ($master_persyaratan_notifikasi as $master_persyaratan_notifikasi_record) {
                                                                                                            $text = '';
                                                                                                            foreach ($persyaratan_notifikasi as $persyaratan_notifikasi_record) {
                                                                                                                if ($master_persyaratan_notifikasi_record['id'] == $persyaratan_notifikasi_record->persyaratan) {
                                                                                                                    $text = 'checked';
                                                                                                                }
                                                                                                            }
                                                                                                            echo "<input type='checkbox' disabled value='" . $master_persyaratan_notifikasi_record['id'] . "' name='persyaratan[]' $text > " . $master_persyaratan_notifikasi_record['nama'] . '<br>';
                                                                                                        }
                                                                                                        ?>
                                                                                    </p>
                                                                                </td>
