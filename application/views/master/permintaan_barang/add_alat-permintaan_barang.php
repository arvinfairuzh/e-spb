...
<form method="POST" autocomplete="off" action="<?= base_url('master/Permintaan_barang/insert_alat') ?>" id="upload-create">
    ...
    <div class="form-group">
        ...
        <input style="" type="text" class="form-control" name="kapasitas[]">
    </div>
    <div class="form-group">
        <label>Merk</label>
        <input style="" type="text" class="form-control" name="merk[]">
    </div>
    <div class="form-group">
        <label>Waktu Pemakaian</label>
        <input style="" type="date" class="form-control" name="waktu_pemakaian[]">
    </div>
